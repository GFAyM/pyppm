...
for ang in range(0,1,1):
	...
	p = np.linalg.inv(m)
	ssc_tot = 0
	fcsd = cloppa_obj.kernel_pathway(FC=True, FCSD=False, PSO=False, n_atom1=[2], n_atom2=[6], princ_prop=p, all_pathways=True)

	for x in itertools.product(occ_lmo,occ_lmo,lmo_vir,lmo_vir):
		ssc = cloppa_obj.kernel_pathway(FC=True, FCSD=False, PSO=False,
										princ_prop=p,
										n_atom1=[2], occ_atom1=x[0][0][ang], 
										n_atom2=[6], occ_atom2=x[1][0][ang],
