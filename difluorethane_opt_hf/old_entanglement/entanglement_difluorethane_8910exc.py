...
for ang in range(0,19,1):
    for i,j,k,l,m,n,o,p in itertools.combinations(V,8):
        ...
        data.append([ang*10, mutual_information, f'{i[2]}_{j[2]}_{k[2]}_{l[2]}_{m[2]}_{n[2]}_{o[2]}_{p[2]}', "Entropía"])
...
fig = px.line(df, x="angulo", y="Entanglement", animation_frame='Virtuals', color='Mutual Information',
       title="Mutual Information Triplet in the Difluorethane (opt-HF) using combinations of 8 virtuals as antibondings, base cc-pvdz",
      )
fig.update_layout(    yaxis_title=r'Entrelazamiento' )

fig.write_html("mutual_inf_triplet_difluorethane_8exc.html", include_mathjax='cdn')
#
...
df = pd.DataFrame(data, columns=['angulo', 'Entanglement', 'Virtuals',  'Mutual Information'])
fig = px.line(df, x="angulo", y="Entanglement", animation_frame='Virtuals', color='Mutual Information',
       title="Mutual Information Singlet in the Difluorethane (opt-HF) using combinations of 8 virtuals as antibondings, base cc-pvdz",
      )
fig.update_layout(    yaxis_title=r'Entrelazamiento' )

fig.write_html("mutual_inf_singlet_difluorethane_8exc.html", include_mathjax='cdn')

### 9exc

data = []
for ang in range(0,19,1):
    for i,j,k,l,m,n,o,p,q in itertools.combinations(V,9):
        mol, mo_coeff = extra_functions(molden_file=f"difluorethane_cc-pvdz_{ang*10}_Cholesky_PM.molden").extraer_coeff
        inv_prop = inverse_principal_propagator(mol=mol, mo_coeff=mo_coeff, o1=[o1[ang]], o2=[o2[ang]], 
                                                v1=[i[0][ang], j[0][ang], k[0][ang], l[0][ang], m[0][ang], n[0][ang],o[0][ang],p[0][ang],q[0][ang]],
                                                v2=[i[1][ang], j[1][ang], k[1][ang], l[1][ang], m[1][ang], n[1][ang],o[1][ang],p[1][ang],q[1][ang]])
        mutual_information = inv_prop.mutual_information
        data.append([ang*10, mutual_information, f'{i[2]}_{j[2]}_{k[2]}_{l[2]}_{m[2]}_{n[2]}_{o[2]}_{p[2]}_{q[2]}', "Entropía"])

df = pd.DataFrame(data, columns=['angulo', 'Entanglement', 'Virtuals',  'Mutual Information'])
fig = px.line(df, x="angulo", y="Entanglement", animation_frame='Virtuals', color='Mutual Information',
       title="Mutual Information Triplet in the Difluorethane (opt-HF) using combinations of 9 virtuals as antibondings, base cc-pvdz",
      )
fig.update_layout(    yaxis_title=r'Entrelazamiento' )

fig.write_html("mutual_inf_triplet_difluorethane_9exc.html", include_mathjax='cdn')
#
...
df = pd.DataFrame(data, columns=['angulo', 'Entanglement', 'Virtuals',  'Mutual Information'])
fig = px.line(df, x="angulo", y="Entanglement", animation_frame='Virtuals', color='Mutual Information',
       title="Mutual Information Singlet in the Difluorethane (opt-HF) using combinations of 9 virtuals as antibondings, base cc-pvdz",
      )
fig.update_layout(    yaxis_title=r'Entrelazamiento' )

fig.write_html("mutual_inf_singlet_difluorethane_9exc.html", include_mathjax='cdn')
...
data = []
for ang in range(0,19,1):
    for i,j,k,l,m,n,o,p,q,r in itertools.combinations(V,10):
        mol, mo_coeff = extra_functions(molden_file=f"difluorethane_cc-pvdz_{ang*10}_Cholesky_PM.molden").extraer_coeff
        inv_prop = inverse_principal_propagator(mol=mol, mo_coeff=mo_coeff, o1=[o1[ang]], o2=[o2[ang]], 
                                                v1=[i[0][ang], j[0][ang], k[0][ang], l[0][ang], m[0][ang], n[0][ang],o[0][ang],p[0][ang],q[0][ang],r[0][ang]],
                                                v2=[i[1][ang], j[1][ang], k[1][ang], l[1][ang], m[1][ang], n[1][ang],o[1][ang],p[1][ang],q[1][ang],r[1][ang]])
        mutual_information = inv_prop.mutual_information
        data.append([ang*10, mutual_information, f'{i[2]}_{j[2]}_{k[2]}_{l[2]}_{m[2]}_{n[2]}_{o[2]}_{p[2]}_{q[2]}_{r[2]}', "Entropía"])

df = pd.DataFrame(data, columns=['angulo', 'Entanglement', 'Virtuals',  'Mutual Information'])
fig = px.line(df, x="angulo", y="Entanglement", animation_frame='Virtuals', color='Mutual Information',
       title="Mutual Information Triplet in the Difluorethane (opt-HF) using combinations of 10 virtuals as antibondings, base cc-pvdz",
      )
fig.update_layout(    yaxis_title=r'Entrelazamiento' )

fig.write_html("mutual_inf_triplet_difluorethane_10exc.html", include_mathjax='cdn')
#
...
for ang in range(0,19,1):
    for i,j,k,l,m,n,o,p,q,r in itertools.combinations(V,10):
        ...
        inv_prop = inverse_principal_propagator(mol=mol, mo_coeff=mo_coeff, spin_dependence="singlet", 
                                            ...
                                            v2=[i[1][ang], j[1][ang], k[1][ang], l[1][ang], m[1][ang], n[1][ang],o[1][ang],p[1][ang],q[1][ang],r[1][ang]])
        mutual_information = inv_prop.mutual_information
        data.append([ang*10, mutual_information, f'{i[2]}_{j[2]}_{k[2]}_{l[2]}_{m[2]}_{n[2]}_{o[2]}_{p[2]}_{p[2]}_{r[2]}', "Entropía"])

df = pd.DataFrame(data, columns=['angulo', 'Entanglement', 'Virtuals',  'Mutual Information'])
fig = px.line(df, x="angulo", y="Entanglement", animation_frame='Virtuals', color='Mutual Information',
       title="Mutual Information Singlet in the Difluorethane (opt-HF) using combinations of 10 virtuals as antibondings, base cc-pvdz",
      )
fig.update_layout(    yaxis_title=r'Entrelazamiento' )

fig.write_html("mutual_inf_singlet_difluorethane_10exc.html", include_mathjax='cdn')