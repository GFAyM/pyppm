...
V = [(v1_1,v1_2,"Csp3-F2pz"), (v6_1,v6_2,"F3px"), (v10_1,v10_2, "F3dxz") ]
...
for ang in range(0,19,1):
    for i,j,k in itertools.combinations(V,3):
        ...
        mutual_information = inv_prop.entropy_iajb_mixedstate
...
fig.write_html("s_iajb_triplet_difluorethane_3exc_Csp3_F3px_F3dxz.html", include_mathjax='cdn')
...
fig.write_html("s_iajb_singlet_difluorethane_3exc_Csp3_F3px_F3dxz.html", include_mathjax='cdn')