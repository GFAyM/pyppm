...
for ang in range(0,19,1):
    for i in itertools.combinations(V,1):
       ...
       mutual_information = inv_prop.entropy_iajb_mixedstate_2
...
fig.show()
fig.write_html("s_iajb_triplet_difluorethane_2exc_2.html", include_mathjax='cdn')
...
fig.update_layout(    yaxis_title=r'Entrelazamiento' )
fig.show()
fig.write_html("s_iajb_singlet_difluorethane_2exc_2.html", include_mathjax='cdn')