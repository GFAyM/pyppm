...
if os.path.exists('cloppa_fcsd_occ_C2F2H4_ccpvdz.txt'):
	os.remove('cloppa_fcsd_occ_C2F2H4_ccpvdz.txt')
...
for ang in range(0,18,1):
	...
	fc = cloppa_obj.kernel_pathway(FC=False, FCSD=True, PSO=False, n_atom1=[2], n_atom2=[6], princ_prop=p)
	#print(fc)
	for i, ii in occ_lmo:
		for j, jj in occ_lmo:
			...
			#print(ssc)
			ssc_tot += ssc
			with open('cloppa_fcsd_occ_C2F2H4_ccpvdz.txt', 'a') as f:
