...
occ_lmo1 = ['F3_2p1','F3_2pz','F3_2p2']
occ_lmo2 = ['F7_2p1','F7_2pz','F7_2p2']
...
lmo_vir = ["F3_3py","F7_3py","F3_2pz","F7_2pz","F3_3px","F7_3px"]
#lmo_vir = ["F3_2pz","F7_2pz"]

lmo_vir1 = ["F3_3py","F3_2pz","F3_3px"]
lmo_vir2 = ["F7_3py","F7_2pz","F7_3px"]
...
for i in occ_lmo1:
    for j in occ_lmo2:
        for a in lmo_vir1:
            for b in lmo_vir2: 
                df_p1 = data_J[(data_J.i.str.contains(i) == True) & (data_J.j.str.contains(j) == True)
                        & (data_J.a.str.contains(a) == True) & (data_J.b.str.contains(b) == True)].reset_index()

#                df_p2 = data_J[(data_J.i.str.contains('F3_2p1') == True) & (data_J.j.str.contains('F7_2p2') == True)
#                        & (data_J.a.str.contains(a) == True) & (data_J.b.str.contains(b) == True)].reset_index()
#
...
plt.title(r'i=F3-2p$_{xyz}$, a=F3-F7(2p$_z$,3p$_{xy}$), j=F3-2p$_{xyz}$, b=F3-F7(2p$_z$,3p$_{xy}$)')# f'a={orb1}, b={orb2}')
#plt.savefig(f'FC_C2F2H4_iajb_F3_+.png', dpi=200)
