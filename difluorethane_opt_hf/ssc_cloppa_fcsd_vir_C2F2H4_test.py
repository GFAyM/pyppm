...
#if os.path.exists('cloppa_fcsd_iajb_C2H4F2.txt'):
#	os.remove('cloppa_fcsd_iajb_C2H4F2.txt')
			...
			for a, aa in lmo_vir:
				for b,bb in lmo_vir:
					...
					p1, m, p2 = cloppa_obj.kernel_pathway_elements(FC=False, FCSD=True, PSO=False,
											princ_prop=p,
											n_atom1=[2], occ_atom1=F3_2px[ang], vir_atom1=v5_1[ang] ,
											n_atom2=[6], occ_atom2=F7_2px[ang], vir_atom2=v5_2[ang], elements=True)
