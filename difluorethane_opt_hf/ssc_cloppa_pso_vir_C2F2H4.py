...
if os.path.exists('cloppa_pso_iajb_C2H4F2.txt'):
	os.remove('cloppa_pso_iajb_C2H4F2.txt')
...
occ_lmo = [(F3_2p1,'F3_2p1'), (F7_2p1,'F7_2p1'), (F3_2p2,'F3_2p2'), (F7_2p2,'F7_2p2')]
occ_lmo1 = [(F3_2p1,'F3_2p1'), (F3_2p2,'F3_2p2')]
occ_lmo2 = [(F7_2p1,'F7_2p1'), (F7_2p2,'F7_2p2')]
...
for ang in range(15,18,1):
	...
	for i, ii in occ_lmo1:
		for j, jj in occ_lmo1:
			...
			pso += cloppa_obj.kernel_pathway(FC=False, FCSD=False, PSO=True,
													princ_prop=p,
			...
			for a, aa in lmo_vir:
				for b, bb in lmo_vir:
					...
					ssc_tot += ssc
					with open('cloppa_pso_iajb_C2H4F2.txt', 'a') as f:
