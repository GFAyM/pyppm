...
class Cloppa:
    ...
    def M(self,triplet=True):
        ...
        eri_mo = ao2mo.general(mol_loc, 
                [mo,mo,mo,mo], compact=False)
    ...
    def pp_ssc_fcsd_pathways(self,princ_prop,n_atom1,occ_atom1,vir_atom1,
                             n_atom2,occ_atom2,vir_atom2,all_pathways,elements):
        nvir = self.nvir
        nocc = self.nocc
