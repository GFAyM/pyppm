...
ax1.plot(data_J.ang, data_J.ent_ia, 'b>-', label=r'$S_{ia}(1)$' )#f'a={orb1} b={orb2}')
...
ax2.plot(data_J.ang, data_J.ent_jb, 'b>-', label=r'$S_{jb}(1)$' )#f'a={orb1} b={orb2}')
#ax2.set_title('S$_{jb}$')# f'a={orb1}, b={orb2}')
ax2.legend()

ax3.set_xlabel('Dihedral angle')
ax3.plot(data_J.ang, data_J.ent_iajb, 'b>-', label=r'$S_{iajb}(2)$' )#f'a={orb1} b={orb2}')
...
ax5.set_title(r'$S_{iajb}(2)$')
#ax5.set_title('Mutual Information ')# f'a={orb1}, b={orb2}')
#ax5.set_title(r'$S_{ia}(1)$ + $S_{jb}(1)$ - $S_{iajb}(2)$')
