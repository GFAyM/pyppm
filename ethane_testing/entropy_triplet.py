...
for ang in range(0,19,1):
    ...
    m_obj = M_matrix_new(occ=occ, vir=vir, mo_coeff=mo_coeff_loc, mol=mol_loc, mo_occ=mo_occ_loc)
    occ1 = H3_1s_occ[ang]
    occ2 = H7_1s_occ[ang]
    vir1 = [H3_1s[ang], H3_2px[ang], H3_2py[ang]]
    vir2 = [H7_1s[ang], H7_2px[ang], H7_2py[ang]]
