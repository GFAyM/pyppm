...
from src.ppe_new import M_matrix as M_matrix_new
...
for ang in range(0,1,1):
    ...
    m_obj = M_matrix_new(mo_coeff=mo_coeff_loc, mol=mol_loc, mo_occ=mo_occ_loc)
    occ1 = H3_1s_occ[ang]
    occ2 = H7_1s_occ[ang]
    vir1 = [H3_1s[ang], H3_2pz[ang], H3_2s[ang], H3_2px[ang], H3_2py[ang]]
    vir2 = [H7_1s[ang], H7_2pz[ang], H7_2s[ang], H7_2px[ang], H7_2py[ang]]
    ent_ia = m_obj.entropy_ia(occ1,vir1)
    ent_jb = m_obj.entropy_ia(occ2,vir2)
