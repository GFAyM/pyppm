...
#    print(m)
    for I,J,K,L in itertools.combinations(V, 4):
            ...
            #print(cruzada)
            M_list_ia.append([ang*10, ent_ia,f'{I[2]}_{J[2]}_{K[2]}_{L[2]}'])
            M_list_jb.append([ang*10, ent_jb,f'{I[2]}_{J[2]}_{K[2]}_{L[2]}'])
...
fig.write_html("entanglement_ia_OH1OH1_comb4.html", include_mathjax='cdn')
...
fig.write_html("entanglement_jb_OH2OH2_comb4.html", include_mathjax='cdn')