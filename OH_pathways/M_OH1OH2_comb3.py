...
#    V = [ (viridx_OH1_2px, viridx_OH2_2px, "2px"),
#         (viridx_OH1_2pz, viridx_OH2_2pz, "2pz"), (viridx_OH1_2s, viridx_OH2_2s, "2s")]
    

    for i,j,k in itertools.combinations(V, 3):
        oh_pathway = np.sum(m[occidx_OH1, [i[0]-9,j[0]-9,k[0]-9], 
                        occidx_OH2, [i[1]-9,j[1]-9,k[1]-9]])        
...
fig.write_html("M_OH1OH2_comb3.html", include_mathjax='cdn')
