...
for ang in range(1,18,1):
    ...
    for i,j,k,l in itertools.combinations(V, 4):
        ...
        oh_pathway = abs(p[occidx_OH1, i[0]-9, occidx_OH2, i[1]-9])        
        oh_pathway += abs(p[occidx_OH1, j[0]-9, occidx_OH2, j[1]-9])
        oh_pathway += abs(p[occidx_OH1, k[0]-9, occidx_OH2, k[1]-9])
        oh_pathway += abs(p[occidx_OH1, l[0]-9, occidx_OH2, l[1]-9])                        
        #oh_pathway += p[occidx_OH1, i[0]-9, occidx_OH2, j[1]-9]        
        #oh_pathway += p[occidx_OH1, j[0]-9, occidx_OH2, i[1]-9]        
        #oh_pathway += p[occidx_OH1, k[0]-9, occidx_OH2, i[1]-9]
        #oh_pathway += p[occidx_OH1, i[0]-9, occidx_OH2, k[1]-9]
        #oh_pathway += p[occidx_OH1, j[0]-9, occidx_OH2, k[1]-9]
        #oh_pathway += p[occidx_OH1, k[0]-9, occidx_OH2, j[1]-9]
...
fig.write_html("Princ_prop_OH_pathways_comb4.html", include_mathjax='cdn')
