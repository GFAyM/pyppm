...
#    print(m)
    for I,J,K,L in itertools.combinations(V, 4):
            ...
            cruzada = m_obj.entropy_iajb_mixedstate
            #print(cruzada)
            M_list.append([ang*10, cruzada,f'{I[2]}_{J[2]}_{K[2]}_{L[2]}'])
...
fig.write_html("entanglement_OH1OH2_comb4.html", include_mathjax='cdn')