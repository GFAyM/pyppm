...
for ang in range(0,19,1):
    for i,j,k in itertools.combinations(V,3):
        ...
        ent_iajb = inv_prop.entropy_iajb_mixedstate
        data.append([ang*10, ent_iajb, f'{i[2]}_{j[2]}_{k[2]}', "Entropía"])

df = pd.DataFrame(data, columns=['angulo', 'Entanglement', 'Virtuals',  'Entropy iajb'])
fig = px.line(df, x="angulo", y="Entanglement", animation_frame='Virtuals', color='Entropy iajb',
       title="Entropy iajb in the Difluorethane (opt-HF) using combinations of 3 virtuals as antibondings, and base cc-pvdz",
      )
fig.update_layout(    yaxis_title=r'Entrelazamiento' )

fig.write_html("entropy_iajb_triplet_difluorethane_3exc.html", include_mathjax='cdn')
...
df = pd.DataFrame(data, columns=['angulo', 'Entanglement', 'Virtuals',  'Entropy iajb'])
fig = px.line(df, x="angulo", y="Entanglement", animation_frame='Virtuals', color='Entropy iajb',
       title="Entropy iajb Singlet in the Difluorethane (opt-HF) using combinations of 3 virtuals as antibondings, and base cc-pvdz",
      )
fig.update_layout(    yaxis_title=r'Entrelazamiento' )

fig.write_html("entropy_iajb_singlet_difluorethane_3exc.html", include_mathjax='cdn')
...
for ang in range(0,19,1):
    for i,j,k,l in itertools.combinations(V,4):
        ...
        #ent_iajbormation = inv_prop.ent_iajbormation
        ent_iajb = inv_prop.entropy_iajb_mixedstate
        data.append([ang*10, ent_iajb, f'{i[2]}_{j[2]}_{k[2]}_{l[2]}', "Entropía"])

df = pd.DataFrame(data, columns=['angulo', 'Entanglement', 'Virtuals',  'Entropy iajb'])
fig = px.line(df, x="angulo", y="Entanglement", animation_frame='Virtuals', color='Entropy iajb',
       title="Entropy iajb Triplet in the Difluorethane (opt-HF) using combinations of 4 virtuals as antibondings, base cc-pvdz",
      )
fig.update_layout(    yaxis_title=r'Entrelazamiento' )

fig.write_html("ent_iajb_triplet_difluorethane_4exc.html", include_mathjax='cdn')
#
...
df = pd.DataFrame(data, columns=['angulo', 'Entanglement', 'Virtuals',  'Entropy iajb'])
fig = px.line(df, x="angulo", y="Entanglement", animation_frame='Virtuals', color='Entropy iajb',
       title="Entropy iajb Singlet in the Difluorethane (opt-HF) using combinations of 4 virtuals as antibondings, base cc-pvdz",
      )
fig.update_layout(    yaxis_title=r'Entrelazamiento' )

fig.write_html("ent_iajb_singlet_difluorethane_4exc.html", include_mathjax='cdn')
...
for ang in range(0,19,1):
    for i,j,k,l,m in itertools.combinations(V,5):
        ...
        #ent_iajbormation = inv_prop.ent_iajbormation
        ent_iajb = inv_prop.entropy_iajb_mixedstate
        data.append([ang*10, ent_iajb, f'{i[2]}_{j[2]}_{k[2]}_{l[2]}_{m[2]}', "Entropía"])

df = pd.DataFrame(data, columns=['angulo', 'Entanglement', 'Virtuals',  'Entropy iajb'])
fig = px.line(df, x="angulo", y="Entanglement", animation_frame='Virtuals', color='Entropy iajb',
       title="Entropy iajb Triplet in the Difluorethane (opt-HF) using combinations of 5 virtuals as antibondings, base cc-pvdz",
      )
fig.update_layout(    yaxis_title=r'Entrelazamiento' )

fig.write_html("ent_iajb_triplet_difluorethane_5exc.html", include_mathjax='cdn')
#
...
df = pd.DataFrame(data, columns=['angulo', 'Entanglement', 'Virtuals',  'Entropy iajb'])
fig = px.line(df, x="angulo", y="Entanglement", animation_frame='Virtuals', color='Entropy iajb',
       title="Entropy iajb Singlet in the Difluorethane (opt-HF) using combinations of 5 virtuals as antibondings, base cc-pvdz",
      )
fig.update_layout(    yaxis_title=r'Entrelazamiento' )

fig.write_html("ent_iajb_singlet_difluorethane_5exc.html", include_mathjax='cdn')

data = []
for ang in range(0,19,1):
    for i,j,k,l,m,n in itertools.combinations(V,6):
        mol, mo_coeff, mo_occ = extra_functions(molden_file=f"difluorethane_cc-pvdz_{ang*10}_Cholesky_PM.molden").extraer_coeff
        inv_prop = inverse_principal_propagator(mol=mol, mo_coeff=mo_coeff, o1=[o1[ang]], o2=[o2[ang]], 
                                                v1=[i[0][ang], j[0][ang], k[0][ang], l[0][ang], m[0][ang], n[0][ang]],
                                                v2=[i[1][ang], j[1][ang], k[1][ang], l[1][ang], m[1][ang], n[1][ang]])
        #ent_iajbormation = inv_prop.ent_iajbormation
        ent_iajb = inv_prop.entropy_iajb_mixedstate
        data.append([ang*10, ent_iajb, f'{i[2]}_{j[2]}_{k[2]}_{l[2]}_{m[2]}_{n[2]}', "Entropía"])

df = pd.DataFrame(data, columns=['angulo', 'Entanglement', 'Virtuals',  'Entropy iajb'])
fig = px.line(df, x="angulo", y="Entanglement", animation_frame='Virtuals', color='Entropy iajb',
       title="Entropy iajb Triplet in the Difluorethane (opt-HF) using combinations of 6 virtuals as antibondings, base cc-pvdz",
      )
fig.update_layout(    yaxis_title=r'Entrelazamiento' )

fig.write_html("ent_iajb_triplet_difluorethane_6exc.html", include_mathjax='cdn')
#
...
df = pd.DataFrame(data, columns=['angulo', 'Entanglement', 'Virtuals',  'Entropy iajb'])
fig = px.line(df, x="angulo", y="Entanglement", animation_frame='Virtuals', color='Entropy iajb',
       title="Entropy iajb Singlet in the Difluorethane (opt-HF) using combinations of 6 virtuals as antibondings, base cc-pvdz",
      )
fig.update_layout(    yaxis_title=r'Entrelazamiento' )

fig.write_html("ent_iajb_singlet_difluorethane_6exc.html", include_mathjax='cdn')