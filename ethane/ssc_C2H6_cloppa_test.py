...
for ang in range(100,110,10):
    ...
    fc = cloppa_obj.kernel_select(FC=True, FCSD=False, PSO=False,n_atom1=[2], n_atom2=[6],all_pathways=True)
    pso = cloppa_obj.kernel_select(FC=False, FCSD=True, PSO=True,n_atom1=[2], n_atom2=[6],all_pathways=True)
