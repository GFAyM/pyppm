...
text = 'cloppa_fc_vir_C2H6_ccpvdz_pzoa.txt'
...
plt.suptitle('FC PZOA contribution to $^3J(H-H)_{ia,jb}$ en C$_2$H$_6$, cc-pVDZ')
plt.title(f'i=j=C-H. a=C-H$_1$(1s, 2s, 2p_xyz) b=C-H$_2$(1s, 2s, 2p_xyz)')# f'a={orb1}, b={orb2}')
#plt.set_size_inches(6.5, 6.5)
plt.savefig(f'FC_pzoa_vir.png', dpi=200)
plt.show()               
