...
ax4.set_title(r'I = $S_{iajb} - S_{ia} - S_{jb}$')
ax4.legend()
plt.suptitle('Entanglement using O-H Ligants and O-H antiligants 1s, 2s, 2px, 2pz and 2py')
#plt.savefig('mutual_information_+2py.png')
plt.show()  