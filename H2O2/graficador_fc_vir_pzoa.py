...
text = 'cloppa_fc_vir_pzoa_H2O2_631G.txt'
...
plt.plot(ang, df_F_C.fc, 'go-', label='$^{FC}J_{ij}(H-H)$')
...
plt.title('i=O-H$_1$ j=O-H$_2$ a=O-H$_1$* b=O-H$_2$*')# f'a={orb1}, b={orb2}')
#plt.set_size_inches(6.5, 6.5)
               
plt.savefig(f'FC_pzoa_vir_H2O2.png', dpi=200)
plt.show()
