...
#ax1.legend()
plt.title(r'''Mutual Information between excitations that contribute the most in $^{PSO}J(F-F)$ in C$_2$H$_4$F$_2$''')#, 2p$_y$ y 2p$_z$')


plt.savefig('mutual_singlet_C2H2F4.png')
plt.show()  