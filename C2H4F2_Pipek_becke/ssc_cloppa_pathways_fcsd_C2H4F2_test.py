...
file = 'cloppa_fcsd_iajb_C2H4F2_test.txt'
...
occ_lmo1 = [(lig1,'F3_2pz')]

occ_lmo2 = [(par_lib_2,'F7_2s')]

lmo_vir1 = [(v1_1,"F3_2pz")]

lmo_vir2 = [(v1_2,"F7_3pz")]
...
plt.plot(data_J.ang, data_J.fcsd, 'b>-', label=f'{i}_{a}_{j}_{b}' )#f'a={orb1} b={orb2}')
