...
ax1.set_title(r'i=F$_1$2p$_{xyz}$, j=F$_1$2p$_{xyz}$')# f'a={orb1}, b={orb2}')
#plt.savefig(f'FC_occ_C2F2H4_sum_2.png', dpi=200)


#ax2.set_ylabel('Hz')
ax2.set_xlabel('Dihedral angle')
ax2.plot(ang, df_F_C_2.pso, 'b>-', label='$^{PSO}J_{ij}(F-F)$' )#f'a={orb1} b={orb2}')
ax2.plot(ang, PSO, 'g<-', label='$^{PSO}J(F-F)$')
ax2.legend()
ax2.set_title(r'i=F$_2$2p$_{xyz}$, j=F$_2$2p$_{xyz}$')# f'a={orb1}, b={orb2}')

#ax3.set_ylabel('Hz')
ax3.set_xlabel('Dihedral angle')
ax3.plot(ang, df_F_C_3.pso, 'b>-', label='$^{PSO}J_{ij}(F-F)$' )#f'a={orb1} b={orb2}')
ax3.plot(ang, PSO, 'g<-', label='$^{PSO}J(F-F)$')
ax3.legend(loc=8)
ax3.set_title(r'i=F$_1$2p$_{xyz}$, j=F$_2$2p$_{xyz}$')# f'a={orb1}, b={orb2}')

plt.savefig('C2F2H4_pso_occ.png')
plt.show()    
