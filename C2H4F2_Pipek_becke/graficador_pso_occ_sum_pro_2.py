...
fig, (ax1, ax2, ax3, ax4) = plt.subplots(1, 3, figsize=(14,10))

ax1.plot(ang, df_F_C_1.pso, 'b>-', label='$^{PSO}J_{ij}(H-H)$' )#f'a={orb1} b={orb2}')
...
ax1.set_title(r'i=[F$_1$2p$_{xyz}$, F$_2$2p$_{xyz}$]')# f'a={orb1}, b={orb2}')
...
plt.suptitle('PSO contribution to $J(F-F)_{i,j}$ in C$_2$F$_2$H$_4$ with 2p occupied LMOs')
ax2.set_title(r'i=F$_1$2p$_{xyz}$, j=F$_1$2p$_{xyz}$')# f'a={orb1}, b={orb2}')
...
ax3.legend()
ax3.set_title(r'i=F$_2$2p$_{xyz}$, j=F$_2$2p$_{xyz}$')# f'a={orb1}, b={orb2}')
...
ax4.legend(loc=8)
ax4.set_title(r'i=F$_1$2p$_{xyz}$, j=F$_2$2p$_{xyz}$')# f'a={orb1}, b={orb2}')
