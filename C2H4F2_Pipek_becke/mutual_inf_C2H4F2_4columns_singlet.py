...
ax4.set_title('I')
#ax4.legend()
plt.suptitle(r'Medidas de entrelazamiento cuántico singlete utilizando ligantes y pares libres 2p$_{xy}$')#, 2p$_y$ y 2p$_z$')
plt.savefig('C2H4F2_entanglement_singlet.png')
plt.show()  