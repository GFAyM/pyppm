...
file = str('classical_correlation_c2h4f2.txt')
...
for ang in range(0,19,1): 
    ...
    inv_prop = M_matrix(mol=mol, mo_coeff=mo_coeff, classical=True, 
                occ = [  par_lib_1[ang] , par_lib_2[ang]],
                vir = [ v1_1[ang ],v4_1[ang], v3_1[ang], 
                        v1_2[ang ],v4_2[ang], v3_2[ang] ])
...
plt.suptitle(r'''Classical Correlation in C$_2$H$_4$F$_2$ 
...
plt.savefig('classical_correlation_c2h4f2.png')
plt.show()
