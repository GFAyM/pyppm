...
plt.plot(df_F_C_1.ang, df_F_C_1.fcsd, 'bo--', label=r'i=C-F$_1$ a=F$_1$2p$_z$, j=C-H$_2$ b=F$_2$2p$_z$')
plt.plot(df_F_C_2.ang, df_F_C_2.fcsd, 'go--', label=r'i=C-F$_1$ a=F$_1$2p$_z$, j=C-H$_2$ b=F$_2$3p$_z$')
plt.plot(df_F_C_3.ang, df_F_C_3.fcsd, 'ro--', label=r'i=C-F$_1$ a=F$_1$3p$_z$, j=C-H$_2$ b=F$_2$3p$_z$')
plt.plot(df_F_C_4.ang, df_F_C_4.fcsd, 'cv--', label=r'i=C-F$_1$ a=F$_1$2p$_z$, j=LP$_2$ b=F$_2$2p$_z$' )
plt.plot(df_F_C_5.ang, df_F_C_5.fcsd, 'mv--', label=r'i=C-F$_1$ a=F$_2$3p$_z$, j=LP$_2$ b=F$_2$2p$_z$' )
plt.plot(df_F_C_6.ang, df_F_C_6.fcsd, 'bv--', label=r'i=C-F$_1$ a=F$_1$3p$_z$, j=LP$_2$ b=F$_2$3p$_z$' )
plt.plot(df_F_C_7.ang, df_F_C_7.fcsd, 'b>--', label=r'i=LP$_1$ a=F$_1$3p$_z$, j=LP$_2$ b=F$_2$3p$_z$' )
plt.plot(df_F_C_8.ang, df_F_C_8.fcsd, 'r>--', label=r'i=LP$_1$ a=F$_1$2p$_z$, j=LP$_2$ b=F$_2$3p$_z$')
plt.plot(df_F_C_9.ang, df_F_C_9.fcsd, 'c>--', label=r'i=LP$_1$ a=F$_1$2p$_z$, j=LP$_2$ b=F$_2$2p$_z$')
...
plt.savefig(f'FCSD_pathways_all.png', dpi=400)
plt.show()                #
