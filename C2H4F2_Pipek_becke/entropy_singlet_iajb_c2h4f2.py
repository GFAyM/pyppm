...
for ang in range(0,19,1): 
	...
	inv_prop = M_matrix(mol=mol, mo_coeff=mo_coeff, triplet=False, 
				occ = [  lig1[ang], par_libx_1[ang], par_liby_1[ang] , 
                         lig2[ang], par_libx_2[ang], par_liby_2[ang]],
				vir = [ v2_1[ang], v3_1[ang],v4_1[ang], v5_1[ang], 
						v2_2[ang], v3_2[ang],v4_2[ang], v5_2[ang] ])
