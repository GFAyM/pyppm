...
plt.plot(df_F_C_1.ang, df_F_C_1.fcsd, 'bo--', label=r'i=C-F$_1$ a=F$_1$2p$_z$, i=C-H$_2$ a=F$_2$2p$_z$')
plt.plot(df_F_C_2.ang, df_F_C_2.fcsd, 'go--', label=r'i=C-F$_1$ a=F$_1$2p$_z$, i=C-H$_2$ a=F$_2$3p$_z$')
plt.plot(df_F_C_3.ang, df_F_C_3.fcsd, 'ro--', label=r'i=C-F$_1$ a=F$_1$3p$_z$, i=C-H$_2$ a=F$_2$3p$_z$')
plt.plot(df_F_C_4.ang, df_F_C_4.fcsd, 'cv--', label=r'i=C-F$_1$ a=F$_1$2p$_z$, i=LP$_2$ a=F$_2$2p$_z$' )
plt.plot(df_F_C_5.ang, df_F_C_5.fcsd, 'mv--', label=r'i=C-F$_1$ a=F$_2$3p$_z$, i=LP$_2$ a=F$_2$2p$_z$' )
plt.plot(df_F_C_6.ang, df_F_C_6.fcsd, 'bv--', label=r'i=C-F$_1$ a=F$_1$3p$_z$, i=LP$_2$ a=F$_2$3p$_z$' )
