...
ax1.plot(ang, df_F_C_3.fcsd, 'g<-', label='$^{FC}J_{ij}(F-F)$')
ax1.set_ylabel('Hz')
...
ax2.plot(ang, df_F_C_1.fcsd, 'b>-', label='$^{FC}J_{ia,jb}(F-F)$' )#f'a={orb1} b={orb2}')
ax2.plot(ang, df_F_C_3.fcsd, 'g<-', label='$^{FC}J_{ij}(F-F)$')
ax2.set_xlabel('Dihedral angle')
ax2.set_title('virt = [2p$_z$, 3p$_z$, 3s]')# f'a={orb1}, b={orb2}')

ax2.legend()

ax3.plot(ang, df_F_C_2.fcsd, 'b>-', label='$^{FC}J_{ia,jb}(F-F)$' )#f'a={orb1} b={orb2}')
ax3.plot(ang, df_F_C_3.fcsd, 'g<-', label='$^{FC}J_{ij}(F-F)$')
...
ax4.plot(ang, df_F_C_5.fcsd, 'b>-', label='$^{FC}J_{ia,jb}(F-F)$' )#f'a={orb1} b={orb2}')
ax4.plot(ang, df_F_C_3.fcsd, 'g<-', label='$^{FC}J_{ij}(F-F)$')
