...
@attr.s
class RPA_loc(RPA):
    """Class to perform calculations of $J^{FC}$ mechanism at RPA level of
    ...
    def pp_rpa_loc(self,atom1, atom2, FC=False, PSO=False, FCSD=False ):
    ...
    def ssc_rpa_loc(self, atom1=None, atom2=None, FC=False, PSO=False, FCSD=False ):
        nocc = self.nocc
        nvir = self.nvir

        if FC:
            h1, m, h2 = self.pp_rpa_loc(FC=True,atom1=atom1,atom2=atom2)
    ...
    def ssc_rpa_loc_pathways(self, atom1=None, atom2=None, 
        ...
        if len(h1.shape)==2:
            ...
            if vir_atom1 is None:
                ...
                vir_atom1 = [a-nocc for a in vir_atom1]
                vir_atom2 = [b-nocc for b in vir_atom2]
