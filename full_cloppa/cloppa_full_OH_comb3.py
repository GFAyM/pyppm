...
for ang in range(1,18,1):
    ...
    for i,j,k in itertools.combinations(V, 3):
        ...
        oh_pathway += p[occidx_OH1, k[0]-9, occidx_OH2, k[1]-9]        
        ...
        M_list.append([ang*10, oh_pathway,f'{i[2]}_{j[2]}_{k[2]}'])
...
fig.write_html("Princ_prop_OH_pathways_comb3.html", include_mathjax='cdn')
