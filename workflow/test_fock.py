...
mol, mo_coeff, mo_occ = extra_functions(molden_file='H2O2_mezcla_30.molden').extraer_coeff
...
print(HRPA(mf).pp_ssc_fc_select([1],[3]))
print(hrpa_loc_obj.pp_ssc_fc_select([1],[3]))