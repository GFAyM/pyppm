...
for ang in range(1,18,1):
    ...
    for i in O:
        ...
        M_diag_list.append([ang*10, diag_m,f'{i[1]}'] )
        inv_M_diag_list.append([ang*10, diag_princ_prop,f'{i[1]}'])
...
fig.write_html("M_matrix_occ_comb1.html", include_mathjax='cdn')
...
fig.write_html("Principal_prop_matrix_occ_comb1.html", include_mathjax='cdn')
