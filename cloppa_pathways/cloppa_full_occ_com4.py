...
for ang in range(1,18,1):
    ...
    for i,j,k,l in itertools.combinations(O,4):
        ...
        M_diag_list.append([ang*10, diag_m,f'{i[1]}_{j[1]}_{k[1]}_{l[1]}'] )
        inv_M_diag_list.append([ang*10, diag_princ_prop,f'{i[1]}_{j[1]}_{k[1]}_{l[1]}'])
...
fig.write_html("M_matrix_occ_comb4.html", include_mathjax='cdn')
...
fig.write_html("Principal_prop_matrix_occ_comb4.html", include_mathjax='cdn')
